...
**v0.6.2 发布准备中。** 八技能、39 文件，ZIP 204,726 字节，SHA-256 `09135f199a66cffd83676a7f7ba29b9de95bd97aef6122eaa33e7b651222e66f`。[本版记录](releases/v0.6.2.md)；[v0.6.1 历史记录](releases/v0.6.1.md)。
...
**v0.6.0 历史安装记录。** [本版说明](releases/v0.6.0.md)登记本地与远端核验；[Release 附件](https://github.com/NingCui29/story-skill/releases/tag/v0.6.0)已公开并完成回下载。v0.5.11 历史固定版仍是原标签与原分发身份；本文对历史名称的遮盖不会更改该标签的目录、附件或 npm 包。请从[对应版本 Release 页面](https://github.com/NingCui29/story-skill/releases/tag/v0.5.11)核对实际旧版资源，不要把下文的新技能名拼进旧标签安装命令。
