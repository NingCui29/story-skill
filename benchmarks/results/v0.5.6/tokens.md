...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 7,918 | 74.44% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 10,505 | 66.09% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 7,918 | 24.03% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 5,345 | 40.58% |
| 深读示范：含按需分析对照样例 | 8,996 | 7,354 | 18.25% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 3,407 | 69.94% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 4,903 | 56.74% |
