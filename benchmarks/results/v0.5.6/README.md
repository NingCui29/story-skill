...
| npm 包 | [npm-package.json](npm-package.json)构建 `@ningcui29/story-skill@0.5.6`；[npm-verify.json](npm-verify.json)逐文件核对 ZIP 与本地 tarball |
...
| GitHub Packages | [工作流 35435102680](https://github.com/NingCui29/story-skill/actions/runs/35435102680) 成功发布公开包 `@ningcui29/story-skill@0.5.6` 并从注册表回下载；[工作流回执](release/packages.json)与回下载产物的[独立核验](release/packages-independent.json)确认 33 个载荷文件、2 个包装文件及本地构建摘要一致 |
