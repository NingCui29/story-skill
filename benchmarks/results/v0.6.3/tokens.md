...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 17,190 | 44.51% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 19,812 | 36.05% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 17,190 | -64.94% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 7,052 | 21.61% |
| 深读示范：含按需分析对照样例 | 8,996 | 9,061 | -0.72% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 6,483 | 42.8% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 12,719 | -12.22% |
