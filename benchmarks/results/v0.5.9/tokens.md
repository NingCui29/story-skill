...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 8,065 | 73.97% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 10,652 | 65.62% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 8,065 | 22.62% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 5,412 | 39.84% |
| 深读示范：含按需分析对照样例 | 8,996 | 7,421 | 17.51% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 3,474 | 69.35% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 5,050 | 55.44% |
