...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 13,422 | 56.67% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 16,044 | 48.21% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 13,422 | -28.79% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 6,148 | 31.66% |
| 深读示范：含按需分析对照样例 | 8,996 | 8,157 | 9.33% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 5,280 | 53.41% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 8,773 | 22.6% |
