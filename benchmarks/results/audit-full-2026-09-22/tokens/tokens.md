...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 10,234 | 66.96% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 12,821 | 58.61% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 10,234 | 1.8% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 5,419 | 39.76% |
| 深读示范：含按需分析对照样例 | 8,996 | 7,428 | 17.43% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 3,854 | 66.0% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 5,565 | 50.9% |
