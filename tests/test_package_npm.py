...
class NpmSuiteTests(unittest.TestCase):
    ...
    def test_only_current_release_family_has_reviewed_layout(self):
        layouts = {"0.6.0": npm.SUITE_FILES_V060, "0.6.1": npm.SUITE_FILES_V061, "0.6.2": npm.SUITE_FILES_V061, "0.6.3": npm.SUITE_FILES_V061}
        skill_layouts = {"0.6.0": npm.SKILL_NAMES_V060, "0.6.1": npm.SKILL_NAMES_V061, "0.6.2": npm.SKILL_NAMES_V061, "0.6.3": npm.SKILL_NAMES_V061}
        ...
        for version in ("0.5.11", "0.6.00", "0.6.4", "0.6.99", "1.0.0"):
