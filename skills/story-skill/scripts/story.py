    ...
    def _queue_short_assembly(self):
        ...
        try:
            ...
            if error.code == "export_conflict":
                fail("assembly_conflict", "Book-title file was edited outside Story Skill; preserve it before recovery",
...
def _load_extension(name):
    spec = importlib.util.spec_from_file_location("story_skill_" + name, Path(__file__).with_name("story_" + name + ".py"))
